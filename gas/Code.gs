...
var SCORES_FIELDS = {
  // スプレッドシート「プルダウン」シート（分野マスター, gid=824716129）の並びに準拠。
  ...
  biology: ['生物の進化','系統と分類','遺伝','細胞と分子','代謝','遺伝情報の発現','発生','遺伝子技術','動物の環境応答','植物の環境応答','生態系'],
  // 基礎科目もプルダウンシートの分野に合わせて明示。
  chem_basics: ['物質','原子の構造と周期表','化学結合と結晶の性質','物質量','濃度','酸・塩基と中和','酸化と還元','電池・電気分解'],
  bio_basics: ['生物の特徴','遺伝子の働き','ヒトの体内環境','遷移','植生','生態系'],
  earth_basics: ['地球の構造','地震','地層と岩石','大気と海洋','宇宙と太陽','日本の季節と災害'],
};
